...
class Genre(Resource):
    ...
    def get(self, genre_id):
        ...
        return TODO.get(record_id=genre_id, crud=GENRE, ns=genre, t_name='genre')

    @genre.doc(model=GENRE_MODEL, body=GENRE_MODEL)
    def post(self):
        """Create new record in the genre table"""
        return TODO.create(crud=GENRE, ns=genre, t_name='genre')

    @genre.doc(params={'genre_id': 'An ID'})
    def put(self, genre_id):
        """Update a record in the genre table"""
        return TODO.update(record_id=genre_id, crud=GENRE, ns=genre, t_name='genre')

    @genre.doc(params={'genre_id': 'An ID'})
    def delete(self, genre_id):
        """Delete a record from the genre table"""
        return TODO.delete(record_id=genre_id, crud=GENRE, ns=genre, t_name='genre')
...
class Genres(Resource):
    ...
    def get(self, page, per_page):
        ...
        return TODO.read_all(crud=GENRE, page=page, per_page=per_page, namespace=genre, t_name='genre')
